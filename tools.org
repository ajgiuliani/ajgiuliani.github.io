...
#+ATTR_HTML: image :title Ion trap vs merged beams  :style float:center;
[[file:img/micra.jpg]]

[fn:tools3]
#+CAPTION: Scheme of principle of the coupling of the linear ion trap with three beamlines at SOLEIL.
#+ATTR_HTML: image :title the SRMS2 project  :style float:center;
[[file:img/SRMS2.jpg]]
...
#+ATTR_HTML: image :title Substance P activation :style float:center;
