...
I picked an xyz domain name because it reminds me the =.xyz= format [fn:1] used to store chemical structures. An =.xyz= file is a representation of a molecular system.  This site could be seen as a representation of me as a scientist!
